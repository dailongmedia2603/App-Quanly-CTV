...
const ApiKeysSettings = () => {
  ...
  const handleSave = async () => {
    ...
    if (error) {
      showError(`Lỗi lưu cài đặt: ${error.message}`);
    } else {
  ...
  const handleTestGeminiConnection = async () => {
    if (!geminiApiKey) {
      showError("Vui lòng nhập Gemini API Key trước.");
      return;
    }
  ...
  const handleTestFacebookConnection = async () => {
    if (!facebookApiUrl) {
      showError("Vui lòng nhập Facebook API URL trước.");
      return;
    }
    if (!facebookApiToken) {
      showError("Vui lòng nhập Facebook API Token trước.");
      return;
    }
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <Button
              ...
              variant="outline"
            >
              {isTestingGemini ? "Đang kiểm tra..." : "Kiểm tra"}
            </Button>
            <div>
      ...
      <Card className="border-orange-200">
        <CardHeader>
          ...
          <CardDescription>
            Cấu hình tích hợp API Facebook bằng URL của bên thứ ba được cung cấp.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-2">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="Nhập Facebook API Token của bạn"
          ...
          <div className="flex items-center justify-between">
            <Button
              ...
              variant="outline"
            >
              {isTestingFacebook ? "Đang kiểm tra..." : "Kiểm tra"}
            </Button>
            <div>
