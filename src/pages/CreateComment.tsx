    ...
    <div>
      <div className="flex justify-between items-center mb-6">
        <div className="space-y-1">
            <h1 className="text-2xl lg:text-3xl font-bold">Comment đã tạo</h1>
            <p className="text-gray-500 mt-1 hidden lg:block">Xem lại các comment bạn đã tạo trước đây.</p>
        </div>
                ...
                <AccordionItem value={log.id} key={log.id} className="bg-white border border-orange-200 rounded-lg shadow-sm">
                  <AccordionTrigger className="p-4 hover:no-underline hover:bg-orange-50/50 rounded-t-lg data-[state=open]:border-b data-[state=open]:border-orange-200">
                    <div className="flex justify-between items-center w-full min-w-0 gap-4">
                      <span className="font-medium text-left text-gray-800 truncate flex-1">{getCommentSnippet(log.generated_content)}</span>
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl lg:text-3xl font-bold">Tạo Comment</h1>
          <p className="text-gray-500 mt-1 hidden lg:block">Sử dụng AI để tạo các bình luận quảng bá dịch vụ một cách tự nhiên.</p>
        </div>
        ...
        <Card className="lg:col-span-2 border-orange-200 min-h-[400px]">
          <CardHeader className="flex flex-row items-center justify-between">
            <div className="space-y-1">
              ...
              <CardDescription className="hidden lg:block">Đây là bình luận do AI tạo ra.</CardDescription>
            </div>
