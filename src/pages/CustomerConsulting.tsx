...
import { Plus, MessageSquare, Send, Bot, User as UserIcon, Trash2, Pencil, Check } from 'lucide-react';
                  ...
                  <div className="space-y-4">
                    {messages.map((msg, index) => (
                      <div key={index} className={cn("flex items-start gap-3", msg.role === 'user' ? 'justify-end' : '')}>
                        ...
                        <div className={cn("max-w-lg p-3 rounded-lg", msg.role === 'user' ? 'bg-blue-500 text-white' : 'bg-white border')}>
