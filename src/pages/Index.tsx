...
const Index = () => {
  ...
  const [updatedGetAllPosts, setUpdatedGetAllPosts] = useState(false);
  ...
  const resetFacebookForm = () => {
    setCampaignName(""); setAudienceType("collaborator"); setSelectedGroups([]); setEndDate(undefined); setScanFrequency(1); setScanUnit("day"); setScanStartDate(undefined); setKeywords(""); setGetAllPosts(false); setUseAiFilter(false); setAiPrompt("");
  };
