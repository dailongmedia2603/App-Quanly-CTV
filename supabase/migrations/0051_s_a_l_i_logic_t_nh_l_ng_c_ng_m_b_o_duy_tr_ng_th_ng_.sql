...
DECLARE
    ...
    end_of_current_month TIMESTAMPTZ := (start_of_current_month + INTERVAL '1 month') - INTERVAL '1 second';
    total_new_contract_value_current NUMERIC;
    fixed_salary_current NUMERIC;

    -- Previous month variables
    start_of_previous_month TIMESTAMPTZ := start_of_current_month - INTERVAL '1 month';
    end_of_previous_month TIMESTAMPTZ := start_of_current_month - INTERVAL '1 second';
